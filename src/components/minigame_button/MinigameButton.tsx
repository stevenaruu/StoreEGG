...
const MinigameButton = () => {
    ...
    return (
        <div className='bg-slate-600 w-32 h-32 flex justify-center items-center rounded-full fixed right-10 bottom-10 shadow-lg cursor-pointer' onClick={goToMinigamePage}>
